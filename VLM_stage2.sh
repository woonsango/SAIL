...
#SBATCH --output=/home/mila/q/qian.yang/LongVLM/Light_Align/VLM_stage2_parallel_output.txt
#SBATCH --error=/home/mila/q/qian.yang/LongVLM/Light_Align/VLM_stage2_parallel_error.txt
#SBATCH --ntasks=1
...
deepspeed --num_gpus=4 /home/mila/q/qian.yang/LongVLM/Light_Align/VLM_Training/train_mem.py \
    --deepspeed /home/mila/q/qian.yang/LongVLM/LLaVA/scripts/zero3.json \
    --model_name_or_path /network/scratch/q/qian.yang/vicuna-7b-v1.5 \
    --version v1 \
    --data_path /home/mila/q/qian.yang/scratch/llava-v1.5-7b/instruct_tuning_data/llava_v1_5_mix665k.json \
