...
def arg_parser(prompt=prompt):
    ...
    parser.add_argument(
        "--mmvet_path",
        type=str,
        default="/home/mila/q/qian.yang/scratch/mmvet/mm-vet",
        help="Download mm-vet.zip and `unzip mm-vet.zip` and change the path here",
    )
    parser.add_argument(
        "--result_file",
        type=str,
        default="/network/scratch/q/qian.yang/light_align/llava_stage2_star7XL_d1024_scale20/mmvet/results/llava_stage2_star7XL_d1024_scale20.json",
        help="path to the model result file, must end with .json",
    )
    parser.add_argument(
        "--result_path",
        type=str,
        default="/network/scratch/q/qian.yang/light_align/llava_stage2_star7XL_d1024_scale20/mmvet/results",
    ...
    parser.add_argument(
        "--gpt_model", type=str, default="gpt-4o", help="gpt model name"
    )
    parser.add_argument(
