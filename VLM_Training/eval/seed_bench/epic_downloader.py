...
class EpicDownloader:
    def __init__(self,
                 ...
                 splits_path_epic_55='/home/mila/q/qian.yang/LongVLM/LLaVA/Visual_Imagine/eval/finetune/seed_bench/data/epic_55_splits.csv',
                 splits_path_epic_100='/home/mila/q/qian.yang/LongVLM/LLaVA/Visual_Imagine/eval/finetune/seed_bench/data/epic_100_splits.csv',
                 md5_path='/home/mila/q/qian.yang/LongVLM/LLaVA/Visual_Imagine/eval/finetune/seed_bench/data/md5.csv',
                 errata_path='/home/mila/q/qian.yang/LongVLM/LLaVA/Visual_Imagine/eval/finetune/seed_bench/data/errata.csv',
                 errata_only=False):
...
def create_parser():
    ...
    parser.add_argument('--output-path', nargs='?', type=str, default='/home/mila/q/qian.yang/scratch/seedbench/EPIC-KITCHENS',
