...
dimension10_dir = "/home/mila/q/qian.yang/scratch/seedbench/20bn-something-something-v2"
# root directory of evaluation dimension 11
dimension11_dir = "/home/mila/q/qian.yang/scratch/seedbench/videos/EPIC-KITCHENS/EPIC-KITCHENS"
# root directory of evaluation dimension 12
dimension12_dir = "/home/mila/q/qian.yang/scratch/seedbench/BreakfastII_15fps_qvga_sync"
...
if __name__ == "__main__":
    data = json.load(open('/home/mila/q/qian.yang/scratch/seedbench/SEED-Bench.json'))
    video_img_dir = '/home/mila/q/qian.yang/scratch/seedbench/v1_video'
    ques_type_id_to_name = {id:n for n,id in data['question_type'].items()}

    video_data = [x for x in data['questions'] if x['data_type'] == 'video' and x['question_type_id'] != 11]
    
    output = '/home/mila/q/qian.yang/scratch/seedbench/SEED-Bench-video-image'
    for qa_item in tqdm(video_data):
        try:
            ...
            print(f'{qa_item} generated an exception: {e}')
