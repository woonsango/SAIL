...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-path",
        type=str,
        default="/network/scratch/q/qian.yang/visual_imagination/llava_stage2_on_100k_random",
    )
    parser.add_argument("--model-base", type=str, default=None)
    parser.add_argument(
        "--image-folder", type=str, default="/home/mila/q/qian.yang/scratch/gqa/images"
    )
    parser.add_argument(
        "--question-file",
        type=str,
        default="/home/mila/q/qian.yang/scratch/llava-v1.5-7b/eval/gqa/llava_gqa_testdev_balanced.jsonl",
    )
    parser.add_argument(
        "--answers-file",
        type=str,
        default="/network/scratch/q/qian.yang/visual_imagination/llava_stage2_on_100k_random/eval/gqa_answer.jsonl",
    )
