...
def load_pretrained_model(
    ...
    **kwargs,
    ...
    custom_config = {
        "vlhead_weights_path": vlhead_weights_path,
    ...
    if "llava" in model_name.lower():
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            if "mpt" in model_name.lower():
                ...
                if "parallel" in model_name.lower():
                    cfg_pretrained = LlavaConfig_Parallel.from_pretrained(model_path)
                    print("Loading LLaVA Parallel model...")
                else:
                ...
                model = AutoModelForCausalLM.from_pretrained(
                    model_path, config=cfg_pretrained, low_cpu_mem_usage=True, **kwargs
                )
    else:
        # Load language model
    ...
    if "llava" in model_name.lower():
        ...
        vision_tower = model.get_vision_tower()[0]
        if device_map != "auto":
