#!/bin/bash
#SBATCH --job-name=TemperatureSchedule
...
output_name="cc3mraw_gtendinoL_bs_${bs}_lion_mean_lr_${lr}_star7L_d${d}_scale${logit_scale}_negbias10_TS"
# output_name="cc3mraw_gtendinoL_bs_${bs}_lion_lr_${lr}_star7L_d${d}"
# ------------------------------------------------------------
